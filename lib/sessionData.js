...
export const sessionData = {
  ...
  session_4_outsidetakestop: {
    ...
    description: "Footwork drill to practice taking the ball with the outside of the foot, then stopping.",
  ...
  session_5_ticktocksoleroll: {
    ...
    description: "Variation of the tick tock drill using sole rolls for added control.",
  ...
  session_6_ticktockoutsidein: {
    ...
    description: "Tick tock variation adding outside-inside touches to increase complexity.",
