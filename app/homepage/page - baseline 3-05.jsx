      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex flex-col sm:flex-row items-center justify-between mb-6 gap-4">
          ...
          <div className="flex items-center gap-4">
            <Link href="/user-settings" className="text-sm text-blue-300 hover:text-blue-400 font-semibold">
              ⚙️ Settings
            </Link>
            <Link href="/logout" className="text-sm text-blue-300 hover:text-blue-400 font-semibold">
              🚪 Logout
            </Link>
          </div>
        </div>
        ...
        {player ? (
          <div className="bg-gradient-to-r from-[#1f2937] to-[#111827] border border-blue-700 p-4 rounded-lg shadow-lg mb-6">
            <div className="flex items-center gap-4">
              <Image
                src={
                  player.avatar_url
              ...
              <div>
                ...
                <p className="text-sm text-blue-300">
                  ...
                  <span className="ml-4">🌍 Rank: {rank != null ? `#${rank}` : 'Calculating...'}</span>
                </p>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto mb-10">
          <Link href="/sacrifice-league/new">
            <div className={`${buttonBase} bg-gradient-to-br from-[#222831] to-[#393e46] hover:scale-105 p-4 sm:p-6 rounded-xl shadow-xl text-center font-bold text-lg sm:text-xl cursor-pointer border border-blue-600 hover:shadow-glow`}>
          ...
          <Link href="/survivor_mode">
            <div className={`${buttonBase} bg-gradient-to-br from-[#2d2d2d] to-[#444] hover:scale-105 p-4 sm:p-6 rounded-xl shadow-xl text-center font-bold text-lg sm:text-xl cursor-pointer border border-red-600 hover:shadow-glow`}>
          ...
          <Link href="/powerplay">
            <div className={`${buttonBase} bg-gradient-to-br from-[#141e30] to-[#243b55] hover:scale-105 p-4 sm:p-6 rounded-xl shadow-xl text-center font-bold text-lg sm:text-xl cursor-pointer border border-green-600 hover:shadow-glow`}>
